    ...
    <div className="min-h-screen bg-slate-900">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="mb-8">
          ...
          <p className="text-slate-400 mt-2">Manage your subscriptions and account settings</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          ...
          <div className="bg-slate-800 rounded-lg p-6 border border-slate-700">
            <div className="flex items-center">
              ...
              <div className="ml-4">
                <p className="text-sm font-medium text-slate-400">Upcoming Renewals</p>
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-slate-400 text-sm">Renewed today</p>
                </div>
                <span className="text-green-400 text-sm">$15.99</span>
              </div>
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-white font-medium">Spotify Premium</p>
                  <p className="text-slate-400 text-sm">Expires in 5 days</p>
                </div>
                <span className="text-yellow-400 text-sm">$9.99</span>
              </div>
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-white font-medium">Adobe Creative Cloud</p>
                  <p className="text-slate-400 text-sm">Renewed 3 days ago</p>
                </div>
                <span className="text-green-400 text-sm">$52.99</span>
              </div>
            </div>
          </div>
        </div>
